...
void fit3d_w(void)
{
 ...
 Float_t Deltam, Dzeromas, Dstarmas, Mygenfla, Dstarcha, Dstp, f_helicity, Gamener, P_piz, P_eta, Vetom1, Vetom2, ProbPi, ProbEta, MPhi, MD0 ,  E9E25, Piflag, Mypgenfl, f_dstcts;
...
//  RooDataSet combData("combData","combData",RooArgSet(helicity,delmass,dzero,w),Index(sample),Import("pos",*data_p),Import("neg",*data_n));
