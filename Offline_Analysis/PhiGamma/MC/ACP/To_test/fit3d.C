...
//  RooRealVar helicity("cos(#theta_{hel})","helicity",-1,1,"no unit");
  ...
  RooDataSet* data_p2=new RooDataSet("data_p2","data_p2",RooArgSet(helicity,delmass,dzero));
  RooDataSet* data_n2=new RooDataSet("data_n2","data_n2",RooArgSet(helicity,delmass,dzero));
...
//Full Model N
  ...
  RooDataSet combData("combData","combData",RooArgSet(helicity,delmass,dzero),Index(sample),Import("pos",*data_p),Import("neg",*data_n),Import("pos2",*data_p2),Import("neg2",*data_n2));
