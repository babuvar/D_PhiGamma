...
data->add(RooArgSet(helicity,delmass,dzero));
  ...
  RooRealVar sig1("sig1","sig1",0.000884);//**
  RooRealVar sig2("sig2","sig2",0.001050);//**
  RooRealVar sig1b("sig1b","sig1b",0.00095);//**
  RooRealVar sig2b("sig2b","sig2b",0.00119);//**
  RooRealVar f_Sig("f_Sig","f_Sig",0.774);//**
  RooRealVar f_Bkg2("f_Bkg2","f_Bkg2",0.772);//**
  ...
  RooRealVar m("m","m",1.86427);//**
  RooRealVar s("s","s",0.011811);//**
  RooRealVar a("a","a",0.735);//**
  RooRealVar n("n","n",7.88);//**
  RooRealVar p1("p1","p1",0.0);   
  RooRealVar c1("param_{expo}","c1",-9,-12,0);
  RooRealVar f1("frac_{cheby/expo}","f1",0.5,0,1);
  RooRealVar m1("m1","m1",1.8472);//**
  RooRealVar s1("s1","s1",0.01261);//**
  RooRealVar A1("A1","A1",0.154);//**
  RooRealVar n1("n1","n1",100.47);//**
