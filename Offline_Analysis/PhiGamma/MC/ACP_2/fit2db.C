...
data_n->add(RooArgSet(helicity,delmass,dzero));
  ...
  RooRealVar m("m","m",1.86472966);//*
  RooRealVar s("s","s",0.01164814);//*
  RooRealVar a("a","a",0.746176);//*
  RooRealVar n("n","n",5.9514);//*
  RooRealVar p1("p1","p1",0.0);   
  RooRealVar c1("param_{expo}","c1",-9,-12,0);
  RooRealVar f1("frac_{cheby/expo}","f1",0.5,0,1);
   RooRealVar m1("m1","m1",1.844896);//*
  RooRealVar s1("s1","s1",0.0144762);//*
  RooRealVar A1("A1","A1",0.19139);//*
  RooRealVar n1("n1","n1",110.8636);//*
