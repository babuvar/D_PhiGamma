...
fom[k][k2]=(float)sqrt((nsignal[k][k2]/10.0)+nback[k][k2])/(nsignal[k][k2]/10.0);
...
cout<<fom[bestk][bestk2]<<"\t"<<nsignal[bestk][bestk2]/10.0<<"\t"<<nback[bestk][bestk2]/10.0<<"\t best E(Gam) = "<<(float)bestk*10+200<<"MeV\t best P*(D*) = "<<(float)bestk2*0.01+2.0<<"GeV"<<endl;
