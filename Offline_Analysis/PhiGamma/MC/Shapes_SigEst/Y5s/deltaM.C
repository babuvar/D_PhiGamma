...
//  chain->Add("PhiGamma_1M_Y5s.root");  
  chain->Add("PhiPi0_2M_Y5s.root"); 
...
data->add(RooArgSet(delmass));
  ...
  RooRealVar sig("#sigma","sig",0.0008,0.0000,0.0050);//sigma);//0.000397327,0,0.003);
  RooRealVar sig1("#sigma_{L}","sig1",0.00089779,0.0006,0.0050);
  RooRealVar sig2("#sigma_{R}","sig2",0.00109104,0.0006,0.0050);
