...
void fit2da(void)
{
  ...
  chain->Add("PhiGamma_4s_FullMC_3.root");
...
data_n->add(RooArgSet(helicity,delmass,dzero));
  ...
  chain->Add("PhiGamma_5s_FullMC_3.root");
...
data_n->add(RooArgSet(helicity,delmass,dzero));
  ...
  RooRealVar sig1("sig1","sig1",0.000849);//**
  RooRealVar sig2("sig2","sig2",0.001025);//**
  RooRealVar f_Sig("f_Sig","f_Sig",0.765);//**

  RooRealVar sig1b("sig1b","sig1b",0.000807);//**
  RooRealVar sig2b("sig2b","sig2b",0.000931);//**
  RooRealVar f_Bkg2("f_Bkg2","f_Bkg2",0.641);//**
