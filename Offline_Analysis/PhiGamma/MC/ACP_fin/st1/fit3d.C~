...
data_n->add(RooArgSet(helicity,delmass,dzero));
  ...
  RooRealVar sig1("sig1","sig1",0.000972);//**
  RooRealVar sig2("sig2","sig2",0.001163);//**
  RooRealVar f_Sig("f_Sig","f_Sig",0.7297);//**

  RooRealVar sig1b("sig1b","sig1b",0.001292);//**
  RooRealVar sig2b("sig2b","sig2b",0.001557);//**
  RooRealVar f_Bkg2("f_Bkg2","f_Bkg2",0.425);//**
  ...
  RooRealVar m("m","m",1.864853);//**
  RooRealVar s("s","s",0.011603);//**
  RooRealVar a("a","a",0.736);//**
  RooRealVar n("n","n",6.22);//**

  RooRealVar p1("p1","p1",0.0);   
  RooRealVar c1("param_{expo}","c1",-9,-12,0);
  RooRealVar f1("frac_{cheby/expo}","f1",0.5,0,1);

   RooRealVar m1("m1","m1",1.84616);//**
  RooRealVar s1("s1","s1",0.01381);//**
  RooRealVar A1("A1","A1",0.168);//**
  RooRealVar n1("n1","n1",54);//**
