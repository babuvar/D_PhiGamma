...
//sigma2=0.00109111;
  ...
  RooRealVar shift2("a_{(shift2)}","a_{(shift2)}",0,-0.5,0.5);
  ...
  RooGenericPdf sigH_p("sigH_p","(helicity-a_{(shift2)})*(helicity-a_{(shift2)})",RooArgSet(helicity,shift2));
...
RooProdPdf Bkg_P("Bkg_P","Bkg_P",RooArgSet(bkg_p,bkgH_p));
  ...
  RooGenericPdf sigH_n("sigH_n","(helicity-a_{(shift2)})*(helicity-a_{(shift2)})",RooArgSet(helicity,shift2));
