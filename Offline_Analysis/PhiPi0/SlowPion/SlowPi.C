...
void SlowPi(void)
{
  //LOAD DATA FILE 
    ...
    TH1F *h1 = new TH1F("Stats1","P_{#pi^{s}} distribution: D^{0} #rightarrow #phi #pi^{0}",100,0,1);  //
    TH1F *h2 = new TH1F("Stats2","P_{#pi^{s}} distribution: D^{0} #rightarrow K_{s} #pi^{0}",100,0,1);  //
    TH1F *h3 = new TH1F("Stats3","cos(#theta_{#pi^{s}}) distribution: D^{0} #rightarrow #phi #pi^{0}",100,-1,1);  //
    TH1F *h4 = new TH1F("Stats4","cos(#theta_{#pi^{s}}) distribution: D^{0} #rightarrow K_{s} #pi^{0}",100,-1,1);  //
